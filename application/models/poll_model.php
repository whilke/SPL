...
class Poll_model extends CI_Model {
	 ...
	 * @return	boolean
	 */
	public function add_vote($option_id, $user_id)
	{
	 ...
	 * @return	boolean
	 */
	public function has_previously_voted($poll_id, $user_id)
	{
	 ...
	 * @return	boolean
	 */
	public function has_previously_voted_within($interval, $poll_id, $user_id)
	{
		$this->db->from($this->options_table)
			->join($this->votes_table, 'votes.option_id = options.option_id')
			->where('options.poll_id', $poll_id)
        ...
        public function is_valid_player($user_id)
        {
            $this->db->from('users u')->
                    join('players p', 'p.strife_id=u.strife_id')->
                    where('u.id', $user_id);
